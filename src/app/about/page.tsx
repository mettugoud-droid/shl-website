...
export const metadata: Metadata = {
  title: 'About Us',
  description:
    'Learn about Sri Harinath Logistics (SHL) – a trusted GST-registered logistics company offering transportation, warehousing, and supply chain solutions across India since 2014.',
  keywords: [
